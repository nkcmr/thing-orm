...
module.exports = function init (connection) {
  ...
  Thing.make = function make_new_thing (name, initialize) {
    ...
    Object.defineProperty(assembler, {
      get: function () {
        return _proto.table
      },
      set: function (to) {
        return _proto.table = to
      },
      enumerable: true
    })

    // alias method => proto
    assembler.proto = assembler.method
        ...
        opts.related = _.map(opts.related, function (attr) {
          ...
          return function saveRelatedThing () {
            if (relatedOpts.relationship === 'hasOne') {
              let $tmp = relatedOpts.link.split('.')
  ...
  /**
   * attributes that are hidden when calling toJSON
   * @type {Array}
   */
  Thing.prototype.hiddenAttributes = []
  ...
  Thing.prototype.toJSON = function () {
    return _.pick(this, _.difference(this._attributes, this.hiddenAttributes))
  }
